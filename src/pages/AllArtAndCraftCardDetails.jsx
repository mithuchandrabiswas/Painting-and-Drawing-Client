...
const AllArtAndCraftCardDetails = () => {
    const allCraft = useLoaderData();
    const { id } = useParams();
    console.log(allCraft);
    const singleCraft = allCraft.find(item => item._id == id);
    const {image, craftName, subCategory, shortDescription, price, rating, customization, processingTime, stockStatus, email, userName } = singleCraft;
...
export default AllArtAndCraftCardDetails;